...
public:
    ...
    void processFrame(Mat& data_input, int codec, string video_file_name);
...
void video::processFrame(Mat& magnitude_frame, int codec, string video_file_name) 
{
