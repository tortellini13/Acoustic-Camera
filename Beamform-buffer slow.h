...
void beamform::handleBeamforming()
{
    ...
    */
    ...
    for (int m = 0; m < m_channels; m++)
    {
        ...
        int m_index_buffer = m * data_beamform_buffer.dim_2 *
        ...
        for (int n = 0; n < n_channels; n++)
        {
            ...
            // Calculate contribution to data_beamform_buffer index
            int n_index_buffer = n * data_beamform_buffer.dim_3 *
                                     data_beamform_buffer.dim_4 *
                                     data_beamform_buffer.dim_5 *
                                     data_beamform_buffer.dim_6; 
            ...
            for (int theta = 0; theta < num_theta; theta++)
            {
                ...
                // Calculate contribution to data_beamform_buffer index
                int theta_index_buffer = theta * data_beamform_buffer.dim_4 *
                                                 data_beamform_buffer.dim_5 *
                                                 data_beamform_buffer.dim_6; 
                ...
                for (int phi = 0; phi < num_phi; phi++)
                {
                    ...
                    // Calculate contribution to data_beamform_buffer index
                    int phi_index_buffer = phi * data_beamform_buffer.dim_5 *
                                                 data_beamform_buffer.dim_6; 
                    ...
                    for (int tap = 0; tap < num_taps; tap++)
                    {
                        ...
                        // Calculate contribution to data_beamform_buffer index
                        int tap_index_buffer = tap * data_beamform_buffer.dim_6; 
